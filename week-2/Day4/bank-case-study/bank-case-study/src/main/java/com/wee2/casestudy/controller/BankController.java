package com.wee2.casestudy.controller;

import com.wee2.casestudy.domain.BankAccount;
import com.wee2.casestudy.dto.AppResponse;
import com.wee2.casestudy.exception.InvalidAmountException;
import com.wee2.casestudy.service.BankService;
...
public class BankController {
    ...
    public ResponseEntity<AppResponse<Double>> depositMoney(@RequestBody BankAccount ba) {
        try {
            double amt = service.deposit(ba.getAcNum(), (int) ba.getBalance());
            var response = new AppResponse<Double>();
