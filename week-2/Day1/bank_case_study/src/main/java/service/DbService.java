...
public class DbService {
    ...
    public int createNewAccount(int acNum, double amt, String acH1dNm, Date crDt, boolean status) throws SQLException {
        var sql = "insert into bank_account values(?,?,?,?,?)";
        var ps1 = connection.prepareStatement(sql);
        ps1.setInt(1, acNum);
        ps1.setDouble(2, amt);
        ps1.setString(3, acH1dNm);
        ps1.setDate(4, crDt);
